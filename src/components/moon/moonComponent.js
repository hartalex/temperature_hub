        ...
        <div style={this.state.style}>
          <div style={this.state.innerStyle}>
            <div style={{ margin: 'auto', width: '130px' }}>
              <img
                src={getMoonIcon(this.state.data.ageOfMoon)}
                alt="moon"
                height="96"
                width="96"
              />
              <div style={{ clear: 'both', color: Colors.White }}>
                {this.state.data.phaseofMoon}
              </div>
              <div
                style={{
                  float: 'left',
              ...
              >
                ...
                <TimeComponent
                  name="rise"
                  hour={this.state.data.sunrise.hour}
                  minute={this.state.data.sunrise.minute}
                />
                <TimeComponent
                  name="set"
                  hour={this.state.data.sunset.hour}
                  minute={this.state.data.sunset.minute}
                />
              </div>
              ...
              >
                ...
                <TimeComponent
                  name="rise"
                  hour={this.state.data.moonrise.hour}
                  minute={this.state.data.moonrise.minute}
                />
                <TimeComponent
                  name="set"
                  hour={this.state.data.moonset.hour}
                  minute={this.state.data.moonset.minute}
                />
              </div>
            </div>
          </div>
