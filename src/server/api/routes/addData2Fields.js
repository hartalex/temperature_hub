const dbModule = require('../db/mongodb')
const slackUrl = require('../../config')
const slackModule = require('../data/slack')
...
function checkExists(dbobj, collection, query, itemName) {
  return new Promise((resolve, reject) => {
    db.queryOneData(dbobj, query, collection, (error, result) => {
