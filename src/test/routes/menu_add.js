...
describe('menu_add', function () {
  describe('#function (req, res)', function () {
    ...
    it('menuAdd no mock fail - date not string', function (done) {
      doTest(done, menuAdd, {body: {date: 0}}, {status:500, result: 'fail', reason: 'date is not a string'})
    })

    it('menuAdd no mock fail - date empty string', function (done) {
      doTest(done, menuAdd, {body: {date: ''}}, {status:500, result: 'fail', reason: 'date is an empty string'})
    })

    it('menuAdd no mock fail - firstOption missing', function (done) {
      doTest(done, menuAdd, {body: {date: ' '}}, {status:500, result: 'fail', reason: 'Property firstOption is missing'})
    })

    it('menuAdd no mock fail - firstOption not string', function (done) {
      doTest(done, menuAdd, {body: {date: ' ', firstOption: 0}}, {status:500, result: 'fail', reason: 'firstOption is not a string'})
    })

    it('menuAdd no mock fail - firstOption empty string', function (done) {
      doTest(done, menuAdd, {body: {date: ' ', firstOption: ''}}, {status:500, result: 'fail', reason: 'firstOption is an empty string'})
    })
    it('menuAdd no mock fail - secondOption missing', function (done) {
      doTest(done, menuAdd, {body: {date: ' ', firstOption: ' '}}, {status:500, result: 'fail', reason: 'Property secondOption is missing'})
    })

    it('menuAdd no mock fail - secondOption not string', function (done) {
      doTest(done, menuAdd, {body: {date: ' ', firstOption: ' ', secondOption: 0}}, {status:500, result: 'fail', reason:  'secondOption is not a string'})
    })

    it('menuAdd no mock fail - secondOption empty string', function (done) {
      doTest(done, menuAdd, {body: {date: ' ', firstOption: ' ', secondOption: ''}}, {status:500, result: 'fail', reason: 'secondOption is an empty string'})
    })

    it('menuAdd no mock fail - otherStuff missing', function (done) {
      doTest(done, menuAdd, {body: {date: ' ', firstOption: ' ', secondOption: ' '}}, {status:500, result: 'fail', reason: 'Property otherStuff is missing'})
    })

    it('menuAdd no mock fail - otherStuff not string', function (done) {
      doTest(done, menuAdd, {body: {date: ' ', firstOption: ' ', secondOption: ' ', otherStuff: 0}}, {status:500, result: 'fail', reason: 'otherStuff is not a string'})
    })

    it('menuAdd no mock fail - otherStuff empty string', function (done) {
      doTest(done, menuAdd, {body: {date: ' ', firstOption: ' ', secondOption: ' ', otherStuff: ''}}, {status:500, result: 'fail', reason: 'otherStuff is an empty string'})
    })
