...
class MoonComponent extends React.Component {
  ...
  getData (that) {
    fetch(ClientConfig.hub_api_url + '/moonPhases')
        ...
        <div style={this.state.style}>
          <div style={this.state.innerStyle}>
            <div style={{ margin: 'auto', width: '125px' }}>
              <img src={moonIcons(this.state.data.ageOfMoon)} height="60" width="60" />
              <div style={{ clear: 'both', color: Colors.White }}>{this.state.data.phaseofMoon}</div>
              <div style={{ float: 'left', paddingLeft: '20px', paddingRight: '20px' }}>
                {this.state.data.percentIlluminated}%{' '}
              </div>
              <div style={{ float: 'left' }}> Age {this.state.data.ageOfMoon}</div>

              <div style={{ clear: 'both', fontSize: '6px', float: 'left', textAlign: 'center' }}>
                <div style={{ width: '60px', fontSize: '8px' }}>Sun</div>
              ...
              <div style={{ float: 'left', fontSize: '6px', textAlign: 'center' }}>
                <div style={{ width: '60px', fontSize: '8px' }}>Moon</div>
          ...
          <div style={{ clear: 'both', color: Colors.White, fontSize: '7px', textAlign: 'right' }}>
            {updateTimeInMinutes}
          </div>
        </div>
      )
